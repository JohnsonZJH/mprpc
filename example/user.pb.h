...
class RegisterResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::fixbug::ResultCode* release_resultcode();
...
inline void RegisterResponse::clear_resultcode() {
  if (GetArenaForAllocation() == nullptr && resultcode_ != nullptr) {
    delete resultcode_;
  }
  resultcode_ = nullptr;
}
...
inline void RegisterResponse::unsafe_arena_set_allocated_resultcode(
    ::fixbug::ResultCode* resultcode) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(resultcode_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.RegisterResponse.ResultCode)
}
...
inline ::fixbug::ResultCode* RegisterResponse::unsafe_arena_release_resultcode() {
...
inline void RegisterResponse::set_allocated_resultcode(::fixbug::ResultCode* resultcode) {
  ...
  if (resultcode) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::fixbug::ResultCode>::GetOwningArena(resultcode);
    if (message_arena != submessage_arena) {
